...
#'
#' @param tree_las an object of class LAS which has points attributed with treeID values, typically computed from lidR::segment_trees.
...
#'
#' @export
get_alphashape_metrics <- function(tree_las, prog_bar = TRUE){
...
mets <- tree_las@data %>% as.data.frame() %>%
